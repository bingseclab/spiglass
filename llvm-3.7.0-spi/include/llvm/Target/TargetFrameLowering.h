...
public:
  TargetFrameLowering(StackDirection D, unsigned StackAl, int LAO,
    ...
    : StackDir(D), StackAlignment(StackAl), TransientStackAlignment(TransAl),
      SPIAlign(0), LocalAreaOffset(LAO), StackRealignable(StackReal) {}
  ...
  virtual void insertDummy(MachineFunction &MF){}
  virtual void createWrapper(MachineFunction &MF){}
  virtual void sanitizeFrame(MachineFunction &MF){}
  virtual void setSPIAlignmentAuto() {}
  void setSPIAlignment(unsigned int SPIAlignIn) { TransientStackAlignment = StackAlignment = SPIAlign = SPIAlignIn; }
  virtual unsigned getSPIAlignment() const { return SPIAlign; }
