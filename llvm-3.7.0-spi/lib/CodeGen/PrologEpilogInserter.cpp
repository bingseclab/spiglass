...
bool PEI::runOnMachineFunction(MachineFunction &Fn) {
  ...
  const_cast<TargetFrameLowering *>(TFI)->setSPIAlignmentAuto();
  ...
  if(TFI->getSPIAlignment()) {
    const_cast<llvm::TargetFrameLowering*>(TFI)->insertDummy(Fn);
    const_cast<llvm::TargetFrameLowering*>(TFI)->createWrapper(Fn);
  }
  ...
  const_cast<llvm::TargetFrameLowering*>(TFI)->sanitizeFrame(Fn);
